...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,name,currentStreak,longestStreak,const DeepCollectionEquality().hash(earnedBadges),const DeepCollectionEquality().hash(adherenceHistory),lastCheckoffDate,equippedBadgeId,phone,bloodType,age,weight,height,email);

@override
String toString() {
  return 'UserProfile(uid: $uid, name: $name, currentStreak: $currentStreak, longestStreak: $longestStreak, earnedBadges: $earnedBadges, adherenceHistory: $adherenceHistory, lastCheckoffDate: $lastCheckoffDate, equippedBadgeId: $equippedBadgeId, phone: $phone, bloodType: $bloodType, age: $age, weight: $weight, height: $height, email: $email)';
}
...
@useResult
$Res call({
 String uid, String name, int currentStreak, int longestStreak, List<Achievement> earnedBadges, Map<String, double> adherenceHistory, DateTime? lastCheckoffDate, String? equippedBadgeId, String? phone, String? bloodType, int? age, double? weight, double? height, String? email
});
...
class _UserProfile implements UserProfile {
  const _UserProfile({required this.uid, required this.name, this.currentStreak = 0, this.longestStreak = 0, final  List<Achievement> earnedBadges = const <Achievement>[], final  Map<String, double> adherenceHistory = const <String, double>{}, this.lastCheckoffDate, this.equippedBadgeId, this.phone, this.bloodType, this.age, this.weight, this.height, this.email}): _earnedBadges = earnedBadges,_adherenceHistory = adherenceHistory;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,name,currentStreak,longestStreak,const DeepCollectionEquality().hash(_earnedBadges),const DeepCollectionEquality().hash(_adherenceHistory),lastCheckoffDate,equippedBadgeId,phone,bloodType,age,weight,height,email);
