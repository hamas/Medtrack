...
mixin _$Achievement {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, type, dateEarned);

  @override
  String toString() {
    return 'Achievement(id: $id, type: $type, dateEarned: $dateEarned)';
  }
}
...
abstract mixin class $AchievementCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, AchievementType type, DateTime dateEarned});
}
...
extension AchievementPatterns on Achievement {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, AchievementType type, DateTime dateEarned)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Achievement() when $default != null:
        return $default(_that.id, _that.type, _that.dateEarned);
      case _:
        return orElse();
    }
  }
...
class _Achievement implements Achievement {
  const _Achievement(
      {required this.id, required this.type, required this.dateEarned});
