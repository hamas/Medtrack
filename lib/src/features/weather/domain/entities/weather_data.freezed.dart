...
mixin _$WeatherData {
 ...
 double get temperature; String get condition; bool get isNight;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WeatherData&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.isNight, isNight) || other.isNight == isNight));
}
...
@useResult
$Res call({
 double temperature, String condition, bool isNight
});
...
/// Create a copy of WeatherData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? temperature = null,Object? condition = null,Object? isNight = null,}) {
...
as String,isNight: null == isNight ? _self.isNight : isNight // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double temperature,  String condition,  bool isNight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WeatherData() when $default != null:
return $default(_that.temperature,_that.condition,_that.isNight);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double temperature,  String condition,  bool isNight)  $default,) {final _that = this;
switch (_that) {
case _WeatherData():
return $default(_that.temperature,_that.condition,_that.isNight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double temperature,  String condition,  bool isNight)?  $default,) {final _that = this;
switch (_that) {
case _WeatherData() when $default != null:
return $default(_that.temperature,_that.condition,_that.isNight);case _:
  return null;
...
class _WeatherData extends WeatherData {
  const _WeatherData({required this.temperature, required this.condition, required this.isNight}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WeatherData&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.isNight, isNight) || other.isNight == isNight));
}
...
/// Create a copy of WeatherData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? temperature = null,Object? condition = null,Object? isNight = null,}) {
