...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,name,dosage,intervalType,customDayInterval,const DeepCollectionEquality().hash(scheduleTimes),mealContext,deliveryMethod,isActive,createdAt);

@override
String toString() {
  return 'Medicine(id: $id, userId: $userId, name: $name, dosage: $dosage, intervalType: $intervalType, customDayInterval: $customDayInterval, scheduleTimes: $scheduleTimes, mealContext: $mealContext, deliveryMethod: $deliveryMethod, isActive: $isActive, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String userId, String name, String dosage, IntervalType intervalType, int? customDayInterval, List<String> scheduleTimes, MealContext mealContext, DeliveryMethod deliveryMethod, bool isActive, DateTime? createdAt
});
...
/// Create a copy of Medicine
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? dosage = null,Object? intervalType = null,Object? customDayInterval = freezed,Object? scheduleTimes = null,Object? mealContext = null,Object? deliveryMethod = null,Object? isActive = null,Object? createdAt = freezed,}) {
...
as DeliveryMethod,isActive: null == isActive ? _self.isActive : isActive // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  String dosage,  IntervalType intervalType,  int? customDayInterval,  List<String> scheduleTimes,  MealContext mealContext,  DeliveryMethod deliveryMethod,  bool isActive,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Medicine() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.dosage,_that.intervalType,_that.customDayInterval,_that.scheduleTimes,_that.mealContext,_that.deliveryMethod,_that.isActive,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  String dosage,  IntervalType intervalType,  int? customDayInterval,  List<String> scheduleTimes,  MealContext mealContext,  DeliveryMethod deliveryMethod,  bool isActive,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Medicine():
return $default(_that.id,_that.userId,_that.name,_that.dosage,_that.intervalType,_that.customDayInterval,_that.scheduleTimes,_that.mealContext,_that.deliveryMethod,_that.isActive,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String name,  String dosage,  IntervalType intervalType,  int? customDayInterval,  List<String> scheduleTimes,  MealContext mealContext,  DeliveryMethod deliveryMethod,  bool isActive,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Medicine() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.dosage,_that.intervalType,_that.customDayInterval,_that.scheduleTimes,_that.mealContext,_that.deliveryMethod,_that.isActive,_that.createdAt);case _:
  return null;
...
class _Medicine implements Medicine {
  const _Medicine({required this.id, required this.userId, required this.name, required this.dosage, required this.intervalType, this.customDayInterval, required final  List<String> scheduleTimes, required this.mealContext, required this.deliveryMethod, this.isActive = true, this.createdAt}): _scheduleTimes = scheduleTimes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,name,dosage,intervalType,customDayInterval,const DeepCollectionEquality().hash(_scheduleTimes),mealContext,deliveryMethod,isActive,createdAt);
...
/// Create a copy of Medicine
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? dosage = null,Object? intervalType = null,Object? customDayInterval = freezed,Object? scheduleTimes = null,Object? mealContext = null,Object? deliveryMethod = null,Object? isActive = null,Object? createdAt = freezed,}) {
