...
mixin _$Medicine {
  ...
  IntervalUnit get intervalUnit;
  List<String> get scheduleTimes;
  MealContext get mealContext;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.scheduleTimes, scheduleTimes) &&
            (identical(other.mealContext, mealContext) ||
  ...
  int get hashCode => Object.hash(
      ...
      intervalCount,
      intervalUnit,
      const DeepCollectionEquality().hash(scheduleTimes),
      mealContext,
      deliveryMethod,
      startDate,
      endDate,
    ...
    return _then(_self.copyWith(
      ...
      scheduleTimes: null == scheduleTimes
          ...
          : scheduleTimes // ignore: cast_nullable_to_non_nullable
              as List<String>,
      mealContext: null == mealContext
          ? _self.mealContext
          : mealContext // ignore: cast_nullable_to_non_nullable
              as MealContext,
...
class _Medicine implements Medicine {
  const _Medicine(
      ...
      this.intervalUnit = IntervalUnit.days,
