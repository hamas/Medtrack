...
mixin _$AdherenceLog {
  ...
  DateTime? get takenTime;
  AdherenceStatus get status;
  String? get mealNotes;
  ...
  $AdherenceLogCopyWith<AdherenceLog> get copyWith =>
      _$AdherenceLogCopyWithImpl<AdherenceLog>(
          this as AdherenceLog, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.takenTime, takenTime) ||
                other.takenTime == takenTime) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.mealNotes, mealNotes) ||
                other.mealNotes == mealNotes));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(
      runtimeType, id, medicineId, scheduledTime, takenTime, status, mealNotes);
...
abstract mixin class $AdherenceLogCopyWith<$Res> {
  factory $AdherenceLogCopyWith(
          AdherenceLog value, $Res Function(AdherenceLog) _then) =
      _$AdherenceLogCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String medicineId,
...
/// @nodoc
class _$AdherenceLogCopyWithImpl<$Res> implements $AdherenceLogCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? takenTime = freezed,
    Object? status = null,
    Object? mealNotes = freezed,
  }) {
    return _then(_self.copyWith(
      ...
      scheduledTime: null == scheduledTime
          ...
          : scheduledTime // ignore: cast_nullable_to_non_nullable
              as DateTime,
      takenTime: freezed == takenTime
          ? _self.takenTime
          : takenTime // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      status: null == status
          ? _self.status
          : status // ignore: cast_nullable_to_non_nullable
              as AdherenceStatus,
      mealNotes: freezed == mealNotes
          ? _self.mealNotes
          : mealNotes // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
}
...
extension AdherenceLogPatterns on AdherenceLog {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdherenceLog value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String medicineId, DateTime scheduledTime,
            DateTime? takenTime, AdherenceStatus status, String? mealNotes)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AdherenceLog() when $default != null:
        return $default(_that.id, _that.medicineId, _that.scheduledTime,
            _that.takenTime, _that.status, _that.mealNotes);
      case _:
        return orElse();
    }
  }
...
class _AdherenceLog implements AdherenceLog {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdherenceLogCopyWith<_AdherenceLog> get copyWith =>
      __$AdherenceLogCopyWithImpl<_AdherenceLog>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdherenceLogToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdherenceLogCopyWith<$Res>
    implements $AdherenceLogCopyWith<$Res> {
  factory _$AdherenceLogCopyWith(
          _AdherenceLog value, $Res Function(_AdherenceLog) _then) =
      __$AdherenceLogCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
