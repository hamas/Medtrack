                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            _TypeOption(
                              ...
                              onTap: () =>
                                  setState(() => _selectedType = 'Capsule'),
                            ),
                            _TypeOption(
                              label: 'Syringe',
                              ...
                              onTap: () =>
                                  setState(() => _selectedType = 'Syringe'),
                            ),
                            _TypeOption(
                              label: 'Syrup',
                        ...
                        Wrap(
                          ...
                          children: <Widget>[
                            ..._selectedTimes.map(
                              (String time) => _ScheduleChip(label: time),
                            ),
                            GestureDetector(
                              onTap: () {},
                              child: Container(
